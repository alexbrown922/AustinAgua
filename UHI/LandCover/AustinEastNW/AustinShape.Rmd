...
```{r}
Fr_Paved=(paved+paved_road)/m_wlr_area

Fr_Bldgs= (structure+tanks+Above_ground+open_storage)/m_wlr_area #This is taken from the sum of all land area coded as structure

Fr_DecTr= tree_area/m_wlr_area
...
Fr_Grass=((pervious*.5)+fields)/m_wlr_area#This is the remaining pervious area as from the land_sum subtracted by the area of the trees and bare soil

Fr_Bsoil=(pervious)*.5/m_wlr_area
