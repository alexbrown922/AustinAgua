...
tree_plot_value = ggplot(tree_value)+
  ...
  scale_fill_gradient2("Value Discrepency",low = "firebrick4", mid = "white", high = "deepskyblue4", breaks=c(min(tree_value$value_disc),0,max(tree_value$value_disc)),labels=c("-$14,000","$0","$20,000"))+
